...
import java.sql.*;
class StudDetails extends JFrame implements ActionListener
{
...
while(rs1.next())
       {
if(rs1.getString(3).equals(clas)&&rs1.getString(4).equals(dept))
{
         cnt++;
