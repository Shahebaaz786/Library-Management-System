...
class StaffReg extends JFrame implements ActionListener  
{
	...
	JTextField  txtFname,txtMname,txtLname,txtCity,txtContact;
		...
		StaffReg()
	{
		...
		try
		{
			BufferedImage img = ImageIO.read(getClass().getResource("/Staff Reg1.png"));
		...
		lblTitle.setBounds(0,05,900,100);
		...
		jcbDept.addItem("General Science");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else
		{
            ...
            PreparedStatement ps1=con.prepareStatement("select * from Staffdetail");
...
String id="STAFF"+cnt;
            ...
            PreparedStatement ps=con.prepareStatement("insert into Staffdetail values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ps.setString(1,id);
            ps.setString(2,String.valueOf(jcbDept.getSelectedItem()));
            ps.setString(3,Fname);
            ps.setString(4,Mname);
            ps.setString(5,Lname);
            ps.setString(6,String.valueOf(jcbGender.getSelectedItem()));
            ps.setString(7,txtCity.getText());
            ps.setString(8,String.valueOf(jcbState.getSelectedItem()));
            ps.setString(9,String.valueOf(jcbDist.getSelectedItem()));
            ps.setString(10,String.valueOf(jcbTaluca.getSelectedItem()));
